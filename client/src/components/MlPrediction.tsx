...
export function MlPrediction(){
  ...
  return <div className="prediction-page ml-prediction-page">
    <div className="prediction-intro"><span className="eyebrow"><Sparkles/> UHS Intelligence</span><h1>Understand what your body is telling you.</h1><p>Select 3–8 symptoms from the trained model dataset. Adding relevant, specific symptoms usually gives the model stronger evidence.</p><div><ShieldCheck/>Your prediction is private and saved to your patient history</div></div>
    <div className="prediction-shell">
      <section className="assessment card"><div className="step-head"><div><small>TRAINED XGBOOST MODEL</small><h2>What are you feeling?</h2></div><span>{selected.length}/8</span></div><div className="progress"><i style={{width:`${selected.length/8*100}%`}}/></div>
