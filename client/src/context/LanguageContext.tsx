...
const urdu:Record<string,string>={
  ...
  "Universal Health System":"یونیورسل ہیلتھ سسٹم","Universal":"عالمی","Health System":"ہیلتھ سسٹم",
  "Excellence in healthcare, connected through one secure and intelligent platform that makes everyday care easier to understand and access.":"صحت کی دیکھ بھال میں بہترین معیار، ایک محفوظ اور ذہین پلیٹ فارم کے ذریعے منسلک، جو روزمرہ نگہداشت کو سمجھنا اور حاصل کرنا آسان بناتا ہے۔",
  "Contact Us":"ہم سے رابطہ کریں","Intelligent Care":"ذہین نگہداشت","Excellence in Service":"خدمات میں بہترین معیار",
  "Secure & Connected":"محفوظ اور مربوط",
  "UHS brings helpful health guidance, meaningful insights, and clearer next steps together in one modern experience. It helps you feel informed before, during, and after every care decision.":"یو ایچ ایس مفید صحت رہنمائی، بامعنی معلومات اور واضح اگلے اقدامات کو ایک جدید تجربے میں یکجا کرتا ہے۔ یہ نگہداشت کے ہر فیصلے سے پہلے، دوران اور بعد میں آپ کو باخبر رکھتا ہے۔",
  "Connect with trusted, verified professionals and manage appointments with less friction. Every interaction is designed to make quality healthcare feel simpler, faster, and more personal.":"قابل اعتماد اور تصدیق شدہ ماہرین سے رابطہ کریں اور اپائنٹمنٹس آسانی سے منظم کریں۔ ہر رابطہ معیاری صحت کی دیکھ بھال کو آسان، تیز اور ذاتی بنانے کے لیے تیار کیا گیا ہے۔",
  "Your health information remains protected, organized, and available in one private place. UHS keeps the details that matter connected, so your care journey stays clear and continuous.":"آپ کی صحت کی معلومات ایک نجی جگہ پر محفوظ، منظم اور دستیاب رہتی ہیں۔ یو ایچ ایس اہم تفصیلات کو مربوط رکھتا ہے تاکہ آپ کا نگہداشت کا سفر واضح اور مسلسل رہے۔",
